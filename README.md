...
For a detailed guide on how to create shaders for this platform, including tips, tricks, and best practices, please see our **[Shader Creation Guide](docs/SHADER-GUIDE.md)**.
